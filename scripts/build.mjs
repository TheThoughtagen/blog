...
export function githubStats(site) {
  ...
  return `<section class="contribution-section" aria-labelledby="contribution-title"><div class="overline">THE PAST YEAR ON GITHUB</div><h2 id="contribution-title">Building, bit by bit.</h2><div data-github-stats><p>Contribution calendar and work totals are loading.</p></div><a href="https://github.com/${e(site.github.username)}?tab=overview" target="_blank" rel="noopener noreferrer">View my GitHub profile &#8599;</a></section>`;
}
...
function home(site) {
  ...
  const body = `<div class="wrap"><div class="eyebrow-line"><span><i class="tiny-square"></i> PERSONAL ENGINEERING LOG</span><span>PATRICK MANNION / FIELDNOTES</span></div>
    ...
    <aside class="notebook-sidebar"><div class="sidebar-heading"><span class="signal-dot"></span> FROM THE WORKBENCH</div>${githubPanel(site, 'activity')}<a class="sidebar-lab-link" href="/lab/">All public activity <span>&#8599;</span></a><div class="sidebar-note"><span class="overline">A QUESTION TO START WITH</span><p>Can the next person <em>diagnose it?</em></p><span>Name the symptom. Explain the next step.</span></div></aside></div>
    </section>
